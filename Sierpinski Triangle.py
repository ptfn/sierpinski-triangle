...
class Example(Frame):
    ...
    def initUI(self):
        ...
        a = Point(random.randrange(100, 900), random.randrange(100, 900), "green")
        a.paint(canvas)

        b = Point(random.randrange(100, 900), random.randrange(100, 900), "green")
        b.paint(canvas)

        c = Point(random.randrange(100, 900), random.randrange(100, 900), "green")
        c.paint(canvas)

        first = Point(random.randrange(200, 500), random.randrange(200, 500), "red")
        first.paint(canvas)
